...
1. **构建镜像**
```bash
docker build -t ponder-knowledge-platform .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name ponder-knowledge-platform ponder-knowledge-platform
```
...
- **项目主页**: https://github.com/MoKangMedical/ponder-knowledge-platform
